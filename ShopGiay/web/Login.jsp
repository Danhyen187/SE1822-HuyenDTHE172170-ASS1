    ...
    <body>
        <div id="logreg-forms">
            ...
            <form class="form-signin" action="login" method="post">
                ...
                <input name="user"  type="text" id="inputEmail" class="form-control mb-2" placeholder="Username" required="" autofocus=""
                ...
                <hr>
                <a href="register" class="btn btn-primary btn-register"><i class="fas fa-user-plus"></i> Sign up New Account</a>
            </form>
            <br>
